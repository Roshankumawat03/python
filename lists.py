...
# print(f"Popped item (last): {popped_item}, List: {my_list}") # Output: Popped item (last): banana, List: ['apple', 'banana', 'cherry']
...
# print(f"Popped item (index 0): {popped_item_at_index}, List: {my_list}") # Output: Popped item (index 0): apple, List: ['banana', 'cherry', 'banana']
...
# print(f"Sorted words: {words}") # Output: Sorted words: ['vipin', 'vipia', 'cherry', 'banana', 'apple']

# Using sorted() (returns new list)
# new_sorted_list = sorted(numbers, reverse=True)
# print(f"New sorted list: {new_sorted_list}") # Output: New sorted list: [11, 9, 8, 5, 2, 1]
# print(f"Original numbers after sorted(): {numbers}") # Output: Original numbers after sorted(): [5, 2, 8, 1, 9, 11]

# sorted_list = sorted("sjhfygr4ikpok093jf09")
# print("".join(sorted_list))
# 003499ffghijjkkoprsy

# Reverse sort
# numbers.sort(reverse=True)
# print(f"Reverse sorted in-place: {numbers}") # Output: Reverse sorted in-place: [11, 9, 8, 5, 2, 1]


my_list = [1, 1, 1, 1, 1, 2, 1, 3, 2, 4, 2]

# print(f"Count of 2: {my_list.count(2)}") # Output: Count of 2: 3
# print(f"Count of 67: {my_list.count(67)}") # Output: count of 67: 0
...
# print(f"Index of 2: {my_list.index(2)}") # Output: Index of 2: 5
# print(f"Index of 1: {my_list.index(1, 5)}") # Output: Index of 2: 6
# print(f"Index of 2: {my_list.index(2, 6)}") # Output: Index of 2: 8
