...
# my_set.update([1, 2, 3, 4, 5, 6]) # 1,2,3 is ignored, 4,5 and 6 are added
...
# print(f"After update({7, 8}): {my_set}") # Output: After update({7, 8}): {1, 2, 3, 7, 8}
...
# my_set.discard(20)
# print(f"After discard(20): {my_set}") # Output: After discard(20): {10, 40, 50, 30} (order may vary)
...
# # Membership
# print(f"Is 3 in my_set? {3 in my_set}")     # Output: Is 3 in my_set? False
...
# print(f"Intersection (set_a.intersection(set_b)): {set_a.intersection(set_b)}") # Output: Intersection (set_a.intersection(set_b)): {3, 4}
