...
class Car:
    ...
    def __mul__(self, right_wala):
        return self.speed * right_wala.speed
    
    def __eq__(self, right_wala):
        return self.speed == right_wala.speed
...
print( my_car + rosan_car )    # Output: 420
print( my_car - rosan_car )    # Output: -180
print( my_car * rosan_car )    # Output: 36000
print( my_car == rosan_car )   # Output: False
